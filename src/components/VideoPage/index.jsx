...
const Index = ({ source, fileType, audioName }) => {
    ...
    const handleEventColor = () => {
        ...
        $(".p_more").click(function () {
            ...
            if (c == 1) {
                $(".progress").append(
                    '<div class="progress bg-transparent relative p_bar_' + c + '" style="width: 1%"></div>'
                );
            } else if (c == "2") {
                $(".progress").append(
                    '<div className="progress-bar bg-success p_bar_' +
                    c +
                    '" style="width: 1%"></div>'
                );
            } else if (c == "3") {
                $(".progress").append(
                    '<div className="progress-bar bg-danger p_bar_' +
                    c +
                    '" style="width: 1%"></div>'
                );
            } else if (c == "4") {
                $(".progress").append(
                    '<div className="progress-bar bg-warning p_bar_' +
                    c +
                    '" style="width: 1%"></div>'
                );
            } else if (c == "5") {
                $(".progress").append(
                    '<div className="progress-bar bg-info p_bar_' +
                    c +
                    '" style="width: 1%"></div>'
                );
            } else if (c == "6") {
